...
class AddHardMes extends Component {
    constructor(props){
        super(props);
    ...
    onSubmit(e){
        ...
        axios.post('/hardwareMES/add', nw,{headers : { 
    ...
    render() {
        return (
            ...
            <div className="container pt-3 pb-5">
                <h3 className="text-center pt-2 pb-2"><b>Add Hardware MES Form</b></h3>
                <div className="card">
