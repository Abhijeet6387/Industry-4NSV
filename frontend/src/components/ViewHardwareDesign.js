...
class ViewHardwareDesign extends Component {
    constructor(props){
        super(props);
            this.state={
                id:'',
        ...
        componentDidMount(){
            ...
            axios.get('/hardwareDesign/details/'+this.props.match.params.id,{headers : { 
        ...
        onSubmit(e){
            ...
            axios.post('/hardwareDesign/update/'+this.props.match.params.id, updated,{headers : { 
                'Authorization' :"Bearer "+token}})
            .then(res =>{
        ...
        deleteHandler(){
            const token= localStorage.getItem("Nsvtoken");
            axios.delete('/hardwareDesign/delete/'+this.props.match.params.id,{headers : { 
                'Authorization' :"Bearer "+token}})
            .then(
                res =>{
...
export default ViewHardwareDesign;